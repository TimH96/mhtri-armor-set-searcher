...
var getSkillActivations = function getSkillActivations(data) {
  var activations = getActivationElements();
  return activations
...
var arrangeSearchData = function arrangeSearchData(skillData) {
  // build params
  var globalSettings = global_settings_component_1.getGlobalSettings();
  var skillActivations = picker_component_1.getSkillActivations(skillData);
...
var searchLogic = function searchLogic(equData, skillData) {
  var searchParams = arrangeSearchData(skillData);
  if (!searchParams) {
    alert('Please select at least one skill');
    return;
  }
  // search for sets
  var result = searcher_module_1.search(
  // equData.armor.map(x => x.filter(y => y.name.startsWith("Helios") && y.name.endsWith("+"))),
  equData.armor, equData.decorations, UserCharmList_1.default.Instance.get(), searchParams, skillData);
  // render results
...
var moreSkillsLogic = function moreSkillsLogic(equData, skillData) {
  return __awaiter(_this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var searchParams, charms, aquirableSkills, _iterator, _step, actMap, sActs, processedActs, _iterator2, _step2, act, newParams, r;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            searchParams = arrangeSearchData(skillData);
            if (searchParams) {
              _context.next = 4;
              break;
            }
          ...
          case 16:
            ...
            r = searcher_module_1.search(equData.armor, equData.decorations, charms, newParams, skillData);
            if (!(r.length === 0)) {
              _context.next = 24;
              break;
            }
    ...
    }, _callee, null, [[7, 39, 42, 45], [14, 29, 32, 35]]);
  }));
};
